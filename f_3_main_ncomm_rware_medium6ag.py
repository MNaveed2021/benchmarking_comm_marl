...
# IA2C (MADDPG) -> RWare Medium 6-Agent
# MA2C_NC (NeurComm) -> RWare Medium 6-Agent
# IA2C_CU (ConsensusUpdate) -> RWare Medium 6-Agent
# MA2C_CNET (CommNet) -> RWare Medium 6-Agent
# MA2C_DIAL (DIAL) -> RWare Medium 6-Agent

# Rename base dir and Recheck config dir and file names when run again
#default_base_dir = "1_IA2C_Rware_Medium6Ag_eps_2e3"
#default_config_dir = './3_Configs_Medium6Ag/config_1_ia2c_rwaremedium6ag_eps_2e3.ini'

#default_base_dir = "2_IA2C_CU_Rware_Medium6Ag_eps_2e3"
#default_config_dir = './3_Configs_Medium6Ag/config_2_ia2c_cu_rwaremedium6ag_eps_2e3.ini'

#default_base_dir = "3_MA2C_NC_Rware_Medium6Ag_eps_2e3"
#default_config_dir = './3_Configs_Medium6Ag/config_3_ma2c_nc_rwaremedium6ag_eps_2e3.ini'

#default_base_dir = "4_MA2C_CNET_Rware_Medium6Ag_eps_2e3"
#default_config_dir = './3_Configs_Medium6Ag/config_4_ma2c_cnet_rwaremedium6ag_eps_2e3.ini'

#default_base_dir = "5_MA2C_DIAL_Rware_Medium6Ag_eps_2e3"
#default_config_dir = './3_Configs_Medium6Ag/config_5_ma2c_dial_rwaremedium6ag_eps_2e3.ini'
