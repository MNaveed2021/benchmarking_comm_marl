...
IA2C, MA2C_NC, IA2C_CU, MA2C_CNET and MA2C_DIAL on RWare Tiny 2-Agent Scenario.
"""
...
# IA2C (MADDPG) -> RWare Tiny 2-Agent
# MA2C_NC (NeurComm) -> RWare Tiny 2-Agent
# IA2C_CU (ConsensusUpdate) -> RWare Tiny 2-Agent
# MA2C_CNET (CommNet) -> RWare Tiny 2-Agent
# MA2C_DIAL (DIAL) -> RWare Tiny 2-Agent

# Rename base dir and Recheck config dir and file names when run again
#default_base_dir = "1_IA2C_Rware_Tiny2Ag_eps_2e3"
#default_config_dir = './1_Configs_Tiny2Ag/config_1_ia2c_rwaretiny2ag_eps_2e3.ini'

#default_base_dir = "2_IA2C_CU_Rware_Tiny2Ag_eps_2e3"
#default_config_dir = './1_Configs_Tiny2Ag/config_2_ia2c_cu_rwaretiny2ag_eps_2e3.ini'

#default_base_dir = "3_MA2C_NC_Rware_Tiny2Ag_eps_2e3"
#default_config_dir = './1_Configs_Tiny2Ag/config_3_ma2c_nc_rwaretiny2ag_eps_2e3.ini'

#default_base_dir = "4_MA2C_CNET_Rware_Tiny2Ag_eps_2e3"
#default_config_dir = './1_Configs_Tiny2Ag/config_4_ma2c_cnet_rwaretiny2ag_eps_2e3.ini'

#default_base_dir = "5_MA2C_DIAL_Rware_Tiny2Ag_eps_2e3"
#default_config_dir = './1_Configs_Tiny2Ag/config_5_ma2c_dial_rwaretiny2ag_eps_2e3.ini'
